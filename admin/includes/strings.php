...
'<form method="post">
	<div class="btn-group" style="margin-bottom:1em;">
		...
		<button name="page" class="btn btn-default"
			value="adminEventView" type="submit" style="width:10em"><span class="glyphicon glyphicon-leaf"></span><br/>View Events</button>
